...
public class WorkshopBookProvider extends PatchouliBookProvider implements IDataProvider {
    ...
    protected void addBooks(Consumer<BookBuilder> consumer) {
        ...
        addStandardEntry(machineCategory, "is used to transform solids into liquids, often with a solid by-product. It can, for example, juice apples and squeeze oil from seeds. It must be triggered each time by a redstone signal pulse.", WorkshopBlocks.PRESS.getItem());
