...
public class MoltenChamberRecipeCategory implements IRecipeCategory<MoltenChamberRecipe> {
    ...
    @Override
    public void draw(MoltenChamberRecipe recipe, double mouseX, double mouseY) {
        slot.draw(29, 42);
        slot.draw(130, 42);
        //arrow.draw(24, 18);
    }
    ...
    @Override
    public void setIngredients(MoltenChamberRecipe seasoningBarrelRecipe, IIngredients ingredients) {
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, MoltenChamberRecipe seasoningBarrelRecipe, IIngredients ingredients) {
