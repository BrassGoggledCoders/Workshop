...
public class WorkshopContainers {
    ...
    public static final RegistryObject<ContainerType<MachineContainer>> MACHINE = CONTAINERS.register("machine",
            () -> IForgeContainerType.create(MachineContainer::create));
